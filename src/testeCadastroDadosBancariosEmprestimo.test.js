...
const rotaUrl = "/v2/pessoas_fisicas/dados_bancarios_emprestimo";
...
describe("SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Suite de Teste API", () => {

  it("SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Get - pessoaFisicaId correto - Status code 200", async () => {
    descricaoTeste = "SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Get - pessoaFisicaId correto - Status code 200";
  ...
  it("SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Get - pessoaFisicaId não existente - Status code 400", async () => {
    descricaoTeste = "SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Get - pessoaFisicaId não existente - Status code 400";
    //Dados do servidor de virtualização
    const virtualServer = "https://api-sv.primecontrol.com.br/MzM1OGVjYjhjMWUwNDRiMDgzYjhlNzljZGM2NTE3OGQ";
    const virutalToken ="";
  ...
  it("SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Get - sem pessoaFisicaId  - Status code 400", async () => {
    descricaoTeste = "SCAF - Previdência - Cadastro - Pessoas Físicas - Dados Bancarios Empréstimo - Get - sem pessoaFisicaId - Status code 400";
    //Dados do servidor de virtualização
    const virtualServer = "https://api-sv.primecontrol.com.br/MzM1OGVjYjhjMWUwNDRiMDgzYjhlNzljZGM2NTE3OGQ";
    const virutalToken ="";
