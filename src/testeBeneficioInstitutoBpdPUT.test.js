...
describe("SCAF - Previdência - Beneficio - Instituto - Suite de Teste API", () => {
    ...
    it.only("SCAF - Previdência - Beneficio - Instituto - PUT - Manutenção BPD - sem informar salário - Status code 400", async () => {
        ...
        await criptografaDados('Vander', '65645/9570','{}', entidade.publicKey);
    ...
    it("SCAF - Previdência - Beneficio - Instituto - PUT - Manutenção BPD - Sucesso - Status code 200", async () => {
        ...
        // body {"salario": 5000 }
        //sinqiaRequestHeader: contratoParticipante = 97042, contratoBPDID = 18888
